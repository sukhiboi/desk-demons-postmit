...
expressApp.get(
  '/user/:username/likes',
  isUserLoggedIn,
  handlers.serveUserProfileWithLikes
);
expressApp.get(
...
expressApp.get('/logout', isUserLoggedIn, function (request, response) {
...
expressApp.post('/saveResponse', isUserLoggedIn, handlers.saveResponse);
